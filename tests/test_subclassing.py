...
class TestCustomValidator(unittest.TestCase):
    ...
    def test_is_validator(self):
        self.failUnless(is_validator(CustomValidator))
        self.failUnless(is_validator(CustomValidator()))
...
class TestNotOneValidator(unittest.TestCase):
    ...
    def test_is_validator(self):
        self.failUnless(is_validator(NotOneValidator))
        self.failUnless(is_validator(NotOneValidator()))
        self.failUnless(is_validator(NotOneValidator(one=2)))
...
class TestCustomCompoundValidator(unittest.TestCase):
    ...
    def test_is_validator(self):
        self.failUnless(is_validator(CustomCompoundValidator))
        self.failUnless(is_validator(self.validator))
...
class TestAllAndNotOneValidator(unittest.TestCase):
    ...
    def test_is_validator(self):
        self.failUnless(is_validator(AllAndNotOneValidator))
        self.failUnless(is_validator(self.validator))
...
class TestDeclarativeAllValidator(unittest.TestCase):
    ...
    def test_is_validator(self):
        self.failUnless(is_validator(DeclarativeAllValidator))
        self.failUnless(is_validator(DeclarativeAllValidator()))

    def test_attrs_deleted(self):
        self.failIf(hasattr(DeclarativeAllValidator, 'first_validator'))
        self.failIf(hasattr(DeclarativeAllValidator, 'second_validator'))
